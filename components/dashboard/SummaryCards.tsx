...
function Card({ label, value, icon, colorClass, bgClass, borderClass, loading }: CardProps) {
  return (
    <div className={`relative overflow-hidden rounded-2xl border ${borderClass} bg-white dark:bg-slate-900/50 backdrop-blur-sm p-5 flex flex-col gap-4 shadow-sm dark:shadow-none`}>
      {/* Background glow */}
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
      ...
      <Card
        ...
        value={finalBalance}
        icon={<Wallet size={18} />}
        colorClass={finalBalance >= 0 ? "text-blue-600 dark:text-blue-400" : "text-rose-600 dark:text-rose-400"}
